...
int main() {
    ...
    windowCreator.width = SCR_WIDTH_INIT;
    windowCreator.height = SCR_HEIGHT_INIT;
    Context::Window windowObj = windowCreator.Create();
    ...
    ImGui_ImplGlfw_InitForOpenGL(windowObj.Handle(), true); // Second param install_callback=true will install GLFW callbacks and chain to existing ones.
