...
namespace Context {
    ...
    int InputObserver::GetFramebufferWidth() { return framebufferWidth; }
    int InputObserver::GetFramebufferHeight() { return framebufferHeight; }
    
    int InputObserver::GetWindowWidth() { return windowWidth; }
    int InputObserver::GetWindowHeight() { return windowHeight; }
